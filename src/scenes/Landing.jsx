      ...
      >
        ...
        <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
          {isAboveMediumScreens ? (
            <div className="relative z-0 before:-z-10 before:absolute before:border-2 before:border-blue before:-top-20 before:-left-20 before:rounded-t-[400px] before:w-full before:max-w[400px] before:h-full ml-20
            ">
        ...
        <div className="z-30 basis-2/5 mt-12 md:mt-32">
          ...
          >
            ...
            <p className="mt-10 mb-7 text-sm text-center md:text-start">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda sunt consequuntur soluta eligendi, debitis optio magnam ut illo alias labore.
            </p>
          </motion.div>
